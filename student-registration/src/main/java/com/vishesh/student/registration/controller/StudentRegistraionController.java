...
/*	@CrossOrigin
	...
	public boolean phoneNumberValidation(@RequestBody UserId phoneNumber) throws Throwable{
		String error;
		if((error=studentRegistrationFieldValidation.phoneNumberValidation(phoneNumber.getUserId()))!="")
		{
			throw new Error(error);
		}
		else
	...
	public boolean emailIdValidation(@RequestBody UserId emailId) throws Throwable{
		String error;
		if((error=studentRegistrationFieldValidation.emailIdValidation(emailId.getUserId()))!="")
		{
			throw new Error(error);
		}
		else
...
//		otpValidationForLogin.validateType(login).getValue();
	...
	public boolean loginPhoneNumberValidation(@RequestBody UserId phoneNumber) throws Throwable{ //$
		String error;
		if((error=studentRegistrationFieldValidation.loginPhoneNumberValidation(phoneNumber.getUserId()))!="")
		{
			throw new Error(error);
		}
		else
	...
	public boolean loginEmailIdValidation(@RequestBody UserId emailId) throws Throwable{
		String error;
		if((error=studentRegistrationFieldValidation.loginEmailIdValidation(emailId.getUserId()))!="")
		{
			throw new Error(error);
		}
		else
	...
	public StudentDetails studentDetailsGet(@RequestBody UserId userId) {
		
		return studentRegistrationService.studentDetailsGet(userId.getUserId());
	}
}
